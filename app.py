...
# Rest of your existing import statements
import dash
...
dcc.DatePickerRange(
    id='date-range',
    start_date=None,  # Set start_date to None
    end_date=dt.now().date(),
    start_date_placeholder_text="DD/MM/YYYY",  # Placeholder for start date
    end_date_placeholder_text="DD/MM/YYYY",  # Placeholder for end date
    display_format="DD/MM/YYYY",  # Display format for the selected date
